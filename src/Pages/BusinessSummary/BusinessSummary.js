...
const BusinessSummary = () => {
    ...
    return (
        <div className='my-32'>
            <h2 className='text-5xl font-sans font-bold flex justify-center items-center h-28 text-primary'> Our Business Summary</h2>
