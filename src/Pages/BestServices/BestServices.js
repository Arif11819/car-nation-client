...
const BestServices = () => {
    return (
        <div class="card lg:card-side my-24 mx-7 my-32 bg-green-700">
            ...
            <div class="card-body mx-10 my-16">
                <h2 class="card-title text-5xl font-sans font-bold text-amber-500">Buy Your Best Product Here</h2>
